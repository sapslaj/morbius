...
// ParseMetric is a (badly) hand-optimized parser that extracts labels from a
// metrics string. This is to avoid importing the entire PromQL parser from
// Prometheus and gives us a little bit of a performance boost.
